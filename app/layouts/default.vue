  ...
  <div>
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-side z-30">
        ...
        <ul class="menu p-4 w-50 min-h-full bg-base-200 text-base-content lg:pt-4">
          ...
          <!-- Tests 메뉴 그룹 -->
          <li class="menu-title mt-4">Tests</li>
          <li><NuxtLink to="/websocket-test" @click="closeDrawer">websocket-test</NuxtLink></li>
          <li><NuxtLink to="/api-stats" @click="closeDrawer">API Stats</NuxtLink></li>
        </ul>
      </div>
    </div>
  </div>
